 ...
 */
class ListPropertiesComponent<T> extends JPanel implements IListPropertiesComponent<T>
{
     ...
     */
    ListPropertiesComponent(Class<?> clazz, Consumer<Boolean> dirtyConsumer, Supplier<T> itemCreator)
    {
