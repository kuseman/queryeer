...
class SqlServerQueryPlanParser
{
    ...
    static Node parseXml(String planXml)
    {
        ...
        try
        {
            ...
            BaseStmtInfoType stmInfo = o.getBatchSequence()
                    .getBatch()
                    .get(0)
                    .getStatements()
                    .get(0)
            ...
            return handle(new Context(), stmInfo, null);
        }
        catch (Exception e)
        {
    ...
    private static NodeHandler<RelOpType> RelOpType_Handler = (Context ctx, RelOpType o, Node parent) ->
    {
        ...
        // TODO: add handlers for ops below, for now we just proceed to the child
        ...
        {
            handle(ctx, o.getUnion(), node);
        }
        else if (o.getUnionAll() != null)
        {
            handle(ctx, o.getUnionAll(), node);
        }
        else if (o.getAssert() != null)
        {
            handle(ctx, o.getAssert(), node);
        }
        return parent;
    };
    ...
    private static NodeHandler<StmtSimpleType> StmtSimpleType_Handler = (Context ctx, StmtSimpleType o, Node parent) ->
    {
        ...
        properties.add(new Node.NodeProperty("BatchModeOnRowStoreUsed", o.isBatchModeOnRowStoreUsed()));
        properties.add(new Node.NodeProperty("CardinalityEstimationModelVersion", o.getCardinalityEstimationModelVersion()));
        properties.add(new Node.NodeProperty("", "Statement", o.getStatementText(), o.getStatementText(), false, List.of()));
        properties.add(new Node.NodeProperty(NodeProperty.STATEMENT_TEXT, o.getStatementText()));

        if (o.getStatementSetOptions() != null)
        {
            NodeProperty options = new NodeProperty("Options", null);
            properties.add(options);

            options.subProperties()
                    .add(new NodeProperty("ANSI_NULLS", BooleanUtils.isTrue(o.getStatementSetOptions()
                            .isANSINULLS())));
            options.subProperties()
                    .add(new NodeProperty("ANSI_PADDING", BooleanUtils.isTrue(o.getStatementSetOptions()
                            .isANSIPADDING())));
            options.subProperties()
                    .add(new NodeProperty("ANSI_WARNINGS", BooleanUtils.isTrue(o.getStatementSetOptions()
                            .isANSIWARNINGS())));
            options.subProperties()
                    .add(new NodeProperty("ARITHABORT", BooleanUtils.isTrue(o.getStatementSetOptions()
                            .isARITHABORT())));
            options.subProperties()
                    .add(new NodeProperty("CONCAT_NULL_YIELDS_NULL", BooleanUtils.isTrue(o.getStatementSetOptions()
                            .isCONCATNULLYIELDSNULL())));
            options.subProperties()
                    .add(new NodeProperty("NUMERIC_ROUNDABORT", BooleanUtils.isTrue(o.getStatementSetOptions()
                            .isNUMERICROUNDABORT())));
            options.subProperties()
                    .add(new NodeProperty("QUOTED_IDENTIFIER", BooleanUtils.isTrue(o.getStatementSetOptions()
                            .isQUOTEDIDENTIFIER())));
        }
