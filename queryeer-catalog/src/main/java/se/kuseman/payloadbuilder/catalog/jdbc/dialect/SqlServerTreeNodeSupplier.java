...
{
    SqlServerTreeNodeSupplier(JdbcDatabase queryeerDatabase, IEventBus eventBus, Icons icons, QueryActionsConfigurable queryActionsConfigurable)
    {
        super(queryeerDatabase, icons, eventBus, queryActionsConfigurable);
    }
