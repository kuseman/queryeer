...
public interface IOutputExtension extends IExtension
{
    ...
    /**
     * Returns true if this extension is auto populated. If true then this extension is not selectable as an output in toolbar and
     * will always get the result written to it.
     */
