...
class SqlServerDocumentParser extends AntlrDocumentParser<Tsql_fileContext>
{
    ...
    SqlServerDocumentParser(Icons icons, JdbcDatabase jdbcDatabase, IEventBus eventBus, QueryActionsConfigurable queryActionsConfigurable, CatalogCrawlService catalogCrawler,
            IConnectionState connectionState, ITemplateService templateService)
    {
        super(jdbcDatabase, eventBus, queryActionsConfigurable, catalogCrawler, connectionState, templateService);
        this.icons = icons;
    }
