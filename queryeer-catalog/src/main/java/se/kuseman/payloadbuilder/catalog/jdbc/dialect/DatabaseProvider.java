...
public class DatabaseProvider
{
    ...
    public DatabaseProvider(CatalogCrawlService crawlService, IEventBus eventBus, Icons icons, QueryActionsConfigurable queryActionsConfigurable)
    {
        sqlServer = new SqlServerDatabase(crawlService, eventBus, icons, queryActionsConfigurable);
        jdbc = new BaseDatabase(icons, crawlService, eventBus, queryActionsConfigurable);
        oracle = new OracleDatabase(icons, crawlService, eventBus, queryActionsConfigurable);
    }
