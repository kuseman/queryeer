...
class OracleDatabase extends BaseDatabase implements JdbcDatabase
{
    ...
    OracleDatabase(Icons icons, CatalogCrawlService crawlService, IEventBus eventBus, QueryActionsConfigurable queryActionsConfigurable)
    {
        super(icons, crawlService, eventBus, queryActionsConfigurable);
    }
