...
class ESCatalogExtension implements ICatalogExtension
{
    ...
    ESCatalogExtension(IQueryFileProvider queryFileProvider, IComponentFactory componentFactory, ESConnectionsModel connectionsModel, String catalogAlias)
    {
    ...
    private void update()
    {
        ...
        if (state.isPresent())
        {
            IQuerySession querySession = state.get()
                    .getSession();
    ...
    private class QuickPropertiesPanel extends JPanel
    {
        ...
        QuickPropertiesPanel()
        {
            ...
            componentFactory.enableAutoCompletion(connections);
            ...
            componentFactory.enableAutoCompletion(indices);
