...
import com.queryeer.api.component.QueryeerTree.CheckBoxNode;
...
class JdbcConnectionsTreeModel implements RegularNode
{
    ...
    /** Database node. Checkbox to be able to multi query of databases */
    class DatabaseNode implements CheckBoxNode
    {
        private final JdbcConnection connection;
        private final JdbcDatabase jdbcDatabase;
